<?php $__env->startSection('content'); ?>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <!--begin::Primary button-->
                        <a href="<?php echo e(route('customer.index')); ?>" class="btn btn-sm fw-bold btn-primary"  >
                       Customer Listing       </a>
                    <!--end::Primary button-->
            </div>
            <!--end::Actions-->
...
<div id="kt_app_content" class="app-content  flex-column-fluid " >
    ...
    <div id="kt_app_content_container" class="app-container  container-xxl ">
        <form id="kt_ecommerce_add_customer_form" class="form d-flex flex-column flex-lg-row" action="<?php echo e(route('customer.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                                    ...
                                    <!--end::Card header-->
                                     ...
                                     <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--begin::Input-->
                                                        <input type="phone" name="phone_number_2" class="form-control mb-2" placeholder="Phone Number 2" value=""  />
                                            <!--end::Input-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vitemart-ec\resources\views/customer/add.blade.php ENDPATH**/ ?>