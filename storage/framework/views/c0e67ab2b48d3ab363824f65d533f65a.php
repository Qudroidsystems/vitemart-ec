...
<div id="kt_app_content" class="app-content  flex-column-fluid " >
    ...
    <div id="kt_app_content_container" class="app-container  container-xxl ">
        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="<?php echo e(route('category.update', $category->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
                                    ...
                                    <!--begin::Image input-->
                                        ...
                                        <style>
                                            .image-input-placeholder {
                                                background-image: url('<?php echo e($category->cover ? asset('storage/' . $category->cover->path) : asset('storage/uploads/category_default.jpg')); ?>');
                                            }
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" name="status" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
                                    ...
                                    <?php else: ?>
                                        <option value="<?php echo e($category->id); ?>" selected>Select Satus</option>
                                    <?php endif; ?>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <!--begin::Input-->
                                    <input type="text" name="name" class="form-control mb-2" placeholder="Category name" value="<?php echo e($category->name); ?>" />
                        <!--end::Input-->
                    ...
                    <div>
                        ...
                        <div id="kt_ecommerce_add_category_description" name="kt_ecommerce_add_category_description" class="min-h-200px mb-2">
                            <?php echo e(nl2br(e(strip_tags($category->description)))); ?>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10">
                        ...
                        <!--begin::Input-->
                        <input type="text" class="form-control mb-2" name="meta_tag_title" placeholder="Meta tag title" value="<?php echo e($category->meta_tag_title); ?>" />
                        <!--end::Input-->
                    ...
                    <div class="mb-10">
                        ...
                        <div id="kt_ecommerce_add_category_meta_description" name="kt_ecommerce_add_category_meta_description" class="min-h-100px mb-2">
                            <?php echo e(nl2br(e(strip_tags($category->meta_tag_description)))); ?>
                    ...
                    <div>
                        ...
                        <!--begin::Editor-->
                        <input id="kt_ecommerce_add_category_meta_keywords" name="meta_tag_keywords" value="<?php echo e($category->meta_tag_keywords); ?>" class="form-control mb-2" />
                        <!--end::Editor-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vitemart-ec\resources\views/category/edit.blade.php ENDPATH**/ ?>