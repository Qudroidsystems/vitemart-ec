...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea id="description" name="description" class="d-none"><?php echo e(nl2br(e(strip_tags(old('description', $product->description) )))); ?></textarea>
                        ...
                        <div data-repeater-item class="form-group d-flex flex-wrap align-items-center gap-5">
                            ...
                            <!--end::Select2-->
                                    ...
                                    <div class="w-100 w-md-800px">
                                        ...
                                        <!--begin::Input-->
                                        <input type="text" name="sku" class="form-control mb-2" placeholder="Barcode Number" value="<?php echo e(old('sku', $product->sku)); ?>" />
                                        <!--end::Input-->
                                     ...
                                     <div class="w-100 w-md-800px">
                                      ...
                                      <div class="w-100 w-md-800px">
                                        ...
                                        <div class="w-100 w-md-800px">
                                            ...
                                            <!--begin::Input-->
                                            <div class="d-flex gap-3">
                                                <input type="number" name="price" class="form-control mb-2" placeholder="On shelf" value="<?php echo e(old('price', $product->base_price)); ?>" />
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vitemart-ec\resources\views/product/edit.blade.php ENDPATH**/ ?>