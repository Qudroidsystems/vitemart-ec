...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('html/assets/assets/js/custom/apps/ecommerce/catalog/categories.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/ecommerce/catalog/save-category.js')}}"></script>
