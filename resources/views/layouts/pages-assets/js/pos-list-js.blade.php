...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('html/assets/assets/js/custom/apps/ecommerce/sales/save-order.js')}}"></script>
    {{-- <script src="{{ asset('html/assets/assets/js/custom/apps/ecommerce/sales/listing.js')}}"></script> --}}
    {{-- <script src="{{ asset('html/assets/assets/js/custom/apps/ecommerce/sales/listing2.js')}}"></script> --}}
    <script src="{{ asset('html/assets/assets/js/custom/pages/general/pos.js')}}"></script>
