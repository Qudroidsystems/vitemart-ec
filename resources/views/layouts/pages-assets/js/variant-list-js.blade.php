...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('html/assets/assets/js/custom/apps/ecommerce/catalog/variant.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/ecommerce/catalog/save-variant.js')}}"></script>
