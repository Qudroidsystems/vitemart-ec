...
<!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('html/assets/assets/js/custom/apps/ecommerce/catalog/tags.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/ecommerce/catalog/save-tag.js')}}"></script>
