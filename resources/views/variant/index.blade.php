            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <a href="{{ route('variant.create') }}" class="btn btn-primary">
                            Add Variant
                        </a>
                        <!--end::Add customer-->
                    </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_variant_table">
                ...
                <tbody class="fw-semibold text-gray-600">
                    @foreach ($variations as $variation)
                            ...
                            <td>
                                <!--begin::Badges-->
                                <div class="badge badge-light-success">{{ $variation->created_at }}</div>
                                <!--end::Badges-->
                            </td>
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                                <a href="{{ route('variant.edit', $variation->id) }}" class="menu-link px-3">
                                                            Edit
                                                        </a>
                                        </div>
                                            <!--end::Menu item-->
                                        ...
                                        data-url="{{ route('variant.destroy', $variation->id) }}"
