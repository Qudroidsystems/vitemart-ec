    ...
    <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-brand-filter="brand_name">{{ $brand->name }}</a>
                                            <!--end::Title-->

                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bold">{{ nl2br(e(strip_tags($brand->description))) }}</div>
                                            <!--end::Description-->
                                        </div>
                                    </div>
                                </td>
