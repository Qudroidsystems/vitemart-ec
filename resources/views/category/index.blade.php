...
@section('content')
    ...
    <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="#" class="symbol symbol-50px">
                                            ...
                                            <span class="symbol-label" style="background-image:url('{{ $category->cover ? asset('storage/' . $category->cover->path) : asset('storage/uploads/category_default.jpg') }}');"></span>
                                        ...
                                        <div class="ms-5">
                                            ...
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bold">{{ nl2br(e(strip_tags($category->description))) }}</div>
                                            <!--end::Description-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <!--begin::Badges-->
                                    <div >{{ nl2br(e(strip_tags($category->meta_tag_title))) }}</div>
                                    <!--end::Badges-->
                                </td>
                                <td>
                                    <!--begin::Badges-->
                                    <div >{{ nl2br(e(strip_tags($category->created_at))) }}</div>
                                    <!--end::Badges-->
                                </td>
                                <td class="text-end">
