...
@section('content')
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <!--begin::Primary button-->
                        <a href="{{ route('category.index') }}" class="btn btn-sm fw-bold btn-primary"  >
                       Category Listing       </a>
                    <!--end::Primary button-->
            </div>
            <!--end::Actions-->
...
<div id="kt_app_content" class="app-content  flex-column-fluid " >
    ...
    <div id="kt_app_content_container" class="app-container  container-xxl ">
        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                                <!--begin::Aside column-->
                                    ...
                                    <!--begin::Image input-->
                                        ...
                                        <style>
                                            .image-input-placeholder {
                                                background-image: url('{{ $category->cover ? asset('storage/' . $category->cover->path) : asset('storage/uploads/category_default.jpg') }}');
                                            }
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" name="status" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
                                    ...
                                    @else
                                        <option value="{{ $category->id }}" selected>Select Satus</option>
                                    @endif
                ...
                <div class="card-body pt-0">
                    ...
                    <div>
                        ...
                        <div id="kt_ecommerce_add_category_description" name="kt_ecommerce_add_category_description" class="min-h-200px mb-2">
                            {{ nl2br(e(strip_tags($category->description))) }}
                        </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10">
                        ...
                        <!--begin::Input-->
                        <input type="text" class="form-control mb-2" name="meta_tag_title" placeholder="Meta tag title" value="{{ $category->meta_tag_title }}" />
                        <!--end::Input-->
                    ...
                    <div class="mb-10">
                        ...
                        <div id="kt_ecommerce_add_category_meta_description" name="kt_ecommerce_add_category_meta_description" class="min-h-100px mb-2">
                            {{ nl2br(e(strip_tags($category->meta_tag_description))) }}
                        </div>
                    ...
                    <div>
                        ...
                        <!--begin::Editor-->
                        <input id="kt_ecommerce_add_category_meta_keywords" name="meta_tag_keywords" value="{{ $category->meta_tag_keywords }}" class="form-control mb-2" />
                        <!--end::Editor-->
