...
var KTAppEcommerceCategories = function () {
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-kt-ecommerce-variant-filter="search"]');
    ...
    var handleDeleteRows = () => {
        const deleteButtons = table.querySelectorAll('[data-kt-ecommerce-variant-filter="delete_row"]');
        ...
        deleteButtons.forEach((d) => {
            d.addEventListener('click', function (e) {
                ...
                const variantName = parent.querySelector('[data-kt-ecommerce-variant-filter="variant_name"]').innerText;
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                if (results.success) {
                                    Swal.fire("Deleted!", `${variantName} has been deleted.`, "success");
                        ...
                        Swal.fire(`${variantName} was not deleted.`, "", "info");
                    }
                });
            });
        });
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_ecommerce_variant_table');
